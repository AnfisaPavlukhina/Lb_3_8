...
![image](https://github.com/user-attachments/assets/da23366f-82cb-4a30-8c08-068f512e4b4f)

Создайте экземпляр класса-наследника Animal, инициализируйте все поля и выполните его Xml-сериализацию. Добавьте в решение новый консольный проект, в котором десериализуйте класс Animal и выведите полученный объект на консоль.

# Код ClassLibrary
```
using System.Xml.Serialization;

namespace Lb_3_8 // Объявление пространства имен, содержащего классы библиотеки.
{
...
namespace Lb_3_81 // Объявление пространства имен, в котором находится текущий класс программы.
{
...
namespace Lb_3_82 // Определение пространства имен для программы.
{
